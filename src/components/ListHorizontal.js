import {StyleSheet, Text, View, FlatList, TouchableOpacity} from 
'react-native';
...
const ItemHorizontal = ({item, variant, onPress}) => {
 ...
 <Text 
style={itemHorizontal.cardTitle}>{item.title}</Text>
 <Text 
style={itemHorizontal.cardText}>{item.createdAt}</Text>
 </View>
 <View>
 </View>
 </View>
